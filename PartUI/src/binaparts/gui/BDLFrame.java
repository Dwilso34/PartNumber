			...
			groupLayout.setHorizontalGroup(
				groupLayout.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(groupLayout.createSequentialGroup()
						...
						.addGap(166)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
							.addComponent(lblBOSAL, GroupLayout.PREFERRED_SIZE, 424, GroupLayout.PREFERRED_SIZE)
							.addGroup(groupLayout.createSequentialGroup()
								.addGap(423)
								.addComponent(lblCUSTOMER, GroupLayout.PREFERRED_SIZE, 361, GroupLayout.PREFERRED_SIZE))))
					.addGroup(groupLayout.createSequentialGroup()
						.addGap(30)
						.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 1110, GroupLayout.PREFERRED_SIZE))
			);
