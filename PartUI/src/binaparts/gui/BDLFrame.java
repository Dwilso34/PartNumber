		...
		class BDLMain extends JPanel 
		{
			...
			//JRadioButtons
				...
				//JComboBoxes
					...
					cboProgram.setBorder(BorderFactory.createLineBorder(Color.BLACK,1));
					cboProgram.setForeground(Color.BLACK);
					cboEngine = new JComboBox();
					cboEngine.setBorder(BorderFactory.createLineBorder(Color.BLACK,1));
