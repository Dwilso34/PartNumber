...
public class MainFrames extends JFrame
{
	...
	//JButton
		...
		//Buttons
			...
			ImageIcon manager = new ImageIcon(getClass().getResource("/images/manageUsers.jpg"));
	...
	//JComboBox
		...
		private JComboBox<?> cboMat;
		JPanel contentPane;	
		@SuppressWarnings("rawtypes")
		private ComboBoxModel resetTypeComboBox()
		{
			JSONArray temp1 = new JSONArray();
			ComboBoxModel<Object> typeComboBoxDefault = null;
			String[] types = null;
			...
			try {
				...
				typeComboBoxDefault = (new DefaultComboBoxModel<Object> (types));
			}catch(Exception ex){/*Ignore*/}
		...
		@SuppressWarnings("rawtypes")
		private ComboBoxModel resetMatComboBox()
		{
			ComboBoxModel<Object> matComboBoxDefault = new DefaultComboBoxModel<Object>();
	...
	//String Panel
		...
		public ManageUsersPanel(final JPanel manage)
		{
		// Bosal Image	
		...
		//Labels	
			...
			lblmanageUsers = new JLabel("Manage Users");
		...
		//RadioButton
			...
			rbtnDeleteUser.setBackground(new Color(95, 95, 95));
			...
			rbtnCreateUser.setBackground(new Color(95, 95, 95));
			...
			rbtnChangeUserRank.setBackground(new Color(95, 95, 95));
			...
			rbtnChangePass.setBackground(new Color(95, 95, 95));
